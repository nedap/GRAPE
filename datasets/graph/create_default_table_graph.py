...
def get_default_features(args, cfg, nodes):
    ...
    super_nodes = {
        ...
        26: [10, 7, 18, 5, 20, 3, 1, 11, 16, 8, 6],     # drawer_base is made up of [vertical_front_panel, foot, bottom_panel, vertical_divider_panel, shelf, vertical_side_panel, leg, bar_stretcher, back_panel, tabletop_connector, cabinet_door_surface]
...
# NOTE if you want to create a graph with double connection for the shared leaf nodes, simply remove the duplicated here, and use the old create_edge_index
